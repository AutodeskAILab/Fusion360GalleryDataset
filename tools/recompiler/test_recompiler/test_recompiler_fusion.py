...
from action_excecutor_fusion import ActionExcecutorFusion
...
def run(context):
    ...
    for i, json_file in enumerate(json_files, start=1):
        ...
        if i == 3:
            ...
            # use Fusion excecutor to turn actions to model
            constructor = ActionExcecutorFusion(actions)
            constructor.traverse_actions()
            constructor.tester(json_file)