...
class SketchExtrudeImporter():
    ...
    def find_profile(self, reconstructed_profiles, profile_uuid, profile_data, xform):
    ...
    def reconstruct_curves(self, sketch, sketch_data, sketch_uuid, sketch_index, xform):
        ...
        for profile_uuid, profile_data in sketch_data["profiles"].items():
            ...
            sketch_profile_data, reconstructed_profile_index = self.find_profile(
                reconstructed_profiles, profile_uuid, profile_data, xform
            )
    ...
    def reconstruct_sketch_curve(self, sketch, sketch_data, sketch_uuid, sketch_index, curve, curve_uuid, points_data, xform):
        ...
        if curve["type"] == "SketchLine":
            curve_obj = self.reconstruct_sketch_line(sketch.sketchCurves.sketchLines, curve, curve_uuid, points_data, xform)
        elif curve["type"] == "SketchArc":
            curve_obj = self.reconstruct_sketch_arc(sketch.sketchCurves.sketchArcs, curve, curve_uuid, points_data, xform)
        elif curve["type"] == "SketchCircle":
            curve_obj = self.reconstruct_sketch_circle(sketch.sketchCurves.sketchCircles, curve, curve_uuid, points_data, xform)
        elif curve["type"] == "SketchEllipse":
            curve_obj = self.reconstruct_sketch_ellipse(sketch.sketchCurves.sketchEllipses, curve, curve_uuid, points_data, xform)
        elif curve["type"] == "SketchFittedSpline":
            curve_obj = self.reconstruct_sketch_fitted_spline(sketch.sketchCurves.sketchFittedSplines, curve, curve_uuid, xform)
        else:
    ...
    def reconstruct_sketch_ellipse(self, sketch_ellipses, curve_data, curve_uuid, points_data, xform):
        ...
        major_axis_point.transformBy(xform)
        minor_axis_point.transformBy(xform)
        center_point.transformBy(xform)
